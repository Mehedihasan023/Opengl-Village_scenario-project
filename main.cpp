...
//tree 5
    ...
    glVertex3f (-92, 20, 0.0);
    glVertex3f(-92, 5, 0);
    glEnd();
// leaf of tree
    glColor3f(0.03, 0.27, 0.06);
    glBegin(GL_TRIANGLES);
    glVertex3f(-98, 15, 0.0);
    glVertex3f (-93.5, 35, 0.0);
    glVertex3f (-89, 15, 0.0);
    glEnd();
    //leaf of tree2
    glColor3f(0.03, 0.27, 0.06);
    glBegin(GL_TRIANGLES);
    glVertex3f(-98, 20, 0.0);
    glVertex3f (-93.5, 39, 0.0);
    glVertex3f (-89, 20, 0.0);
    glEnd();
//2nd tree
// tree 2
    glColor3f(0.41, 0.23, 0.01);
...
// head of mosq 2
    ...
    glBegin(GL_TRIANGLES);
    glVertex3f(-8, 53, 0.0);
    glVertex3f (-10, 59, 0.0);
    glVertex3f (-12, 53, 0.0);
    glEnd();
//  head of mosq 3
    glColor3f(0.14, 0.51, 0.48);
    glBegin(GL_POLYGON);
...
// upper wall
 glColor3f(0.77, 0.63, 0.44);
    glBegin(GL_QUADS);
    glVertex3f(-28, 40, 0.0);
    glVertex3f (-28, 47, 0.0);
    glVertex3f (-23, 47, 0.0);
    glVertex3f(-23, 40, 0);
    glEnd();
//upper wall2
    glColor3f(.77, 0.63, 0.44);
    glBegin(GL_QUADS);
    glVertex3f(-30, 47, 0.0);
    glVertex3f (-30, 48, 0.0);
    glVertex3f (-21, 48, 0.0);
    glVertex3f(-21, 47, 0);
    glEnd();
//  window
    glColor3f(1, 1, 1);
    ...
    glVertex3f (-27, 46, 0.0);
    glVertex3f (-24, 46, 0.0);
    glVertex3f(-24, 41, 0);
    glEnd();
//window
    glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex3f(-25.5, 41, 0.0);
    glVertex3f (-25.5, 46, 0.0);
    glEnd();
    //
     glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex3f(-27, 43.5, 0.0);
    glVertex3f (-24, 43.5, 0.0);
    glEnd();
// door of moshq
   //house 2
    glColor3f(1, 1, 1);
...
// line of door
    glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex3f(-14.9, 5, 0.0);
    glVertex3f (-14.9, 28.6, 0.0);
    glEnd();
    //
    glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex3f(-14.8, 5, 0.0);
    glVertex3f (-14.8, 28.6, 0.0);
    glEnd();
//  window of mosq 2
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    glVertex3f(-28, 28, 0.0);
    glVertex3f (-28, 35, 0.0);
